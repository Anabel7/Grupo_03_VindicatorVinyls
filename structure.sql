...
CREATE TABLE `user_products` (
   `carrito_id` INT  UNSIGNED AUTO_INCREMENT,
...
CREATE TABLE `label_products` (
	`labelProd_id` INT UNSIGNED AUTO_INCREMENT,
    `label_id` INT UNSIGNED NOT NULL,
    `product_id` INT UNSIGNED NOT NULL,
    `created_at` DATETIME,
   `updated_at` DATETIME,
   PRIMARY KEY (`labelProd_id`)
);
...
ALTER TABLE `user_products` ADD CONSTRAINT `FK_04b1cb78-314d-4d77-9ca2-02ecc8339d99` FOREIGN KEY (`user_id`) REFERENCES `users`(`user_id`)  ;
